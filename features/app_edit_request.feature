Feature: staff should be able to approve or comment on requested feature changes or additions made by a user
  ...
  So that I approve of or give feedback on requested feature changes or new features on existing apps made by users
  ...
  Background: seed data and log in
    Given the following apps exist:
      ...
      | 102 | app2  | test2       | 1      | dead        | p2.com              | repo-url2.com  | deploy-url2.com | f2       |
    ...
    And the following App Edit Requests exist:
      ...
      | 1  | app1         | test1       |          | submitted   |               | 101    | 2               |             | 2019-11-20 10:44:50 -0800  |            |
      | 2  | app2         | test2       |          | submitted   |               | 102    | 2               |             | 2019-11-20 9:05:50 -0800   |            |
...
Scenario: A logged in coach user can see list of App Edit Requests in 'App Edit Requests' tab
  ...
  Then I should see "app2" before "app1"
...
Scenario: A logged in coach user can view an App Edit (Feature Change) Request through the 'App Edit Requests' index
  Given I am logged in
  When I follow "App Edit Requests"
  When I follow the App Edit Request with id 2   #TODO: add app name to css class name to check that correct button is clicked
  Then I should see /Request Change for App "app2"/
  #Then I should see "Status: vetting pending" #TODO: this test is failing: status should be updated to vetting pending
